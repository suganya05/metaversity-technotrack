        ...
        <div className="stories-content">
          <div className="stories">
            ...
            <p>
              ...
              amazing and puts in their best efforts to help us understand each
              topic, and the program content was well structured. Special thanks
              to GL Excelerate for helping us be interview-ready.
            </p>
